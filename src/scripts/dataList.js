...
function renderData() {
    ...
    dataArray.forEach(car => {
        ...
        // Create a new HTML element to help up format the data's value
    ...
    // Add the list containter onto the actual HTML page
...
function addCarToDataList(event, targetInputId) {
    ...
    // User the form element.checkValidity() method and save the result
    let isFormValid = formElement.checkValidity();
    console.log("isFormElement value: " + isFormValid);
